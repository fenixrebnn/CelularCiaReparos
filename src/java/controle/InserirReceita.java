...
public class InserirReceita extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Inserir Receita</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            try {
                ...
                if (id_servico <= 0) {
                    ...
                    r.setId_servico(id_servico);
                    r.setCustoPecas(custoPecas);
                    r.setValorServico(valorServico);
                    r.setLucro(lucro);
                    ...
                    out.print("alert('Receita inserida com sucesso!!');");
    ...
    public String getServletInfo() {
        return "Servlet para inserir receita";
    }
}
