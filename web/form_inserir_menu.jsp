...
<body>
    ...
    <div class="container mt-3">
        <h2 class="text-center">Inserir Menu</h2>
        <form name="form_menu" action="inserir_menu.do" method="post" onsubmit="return validaForm();" class="needs-validation" novalidate>
